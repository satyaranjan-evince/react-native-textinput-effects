      ...
      >
        ...
        <TextInput
          ...
          style={[
            styles.textInput,
            {
              marginLeft: iconWidth + inputPadding + (this.props.forPhonenumber && !this.props.isRTL? (dialCode.length == 4 ? 65 : 45) : 0),
              marginRight: iconWidth + inputPadding+ (this.props.forPhonenumber && !this.props.isRTL? (dialCode.length == 4 ? 65 : 45) : 0),

      ...
      >
        ...
        <TextInput
          ...
          style={[
            ...
            this.props.isRTL ? {
              right: this.props.forPhonenumber ? (dialCode.length == 0 ? 5 : (dialCode.length * 15 +  (dialCode.length == 1 ? 20 : 10))) : 5,
              left: 5
            } : {
              left: this.props.forPhonenumber ? (dialCode.length == 0 ? 5 : (dialCode.length * 15 + (dialCode.length == 1 ? 20 : 10))) : 5,
              right: 5
            }
          ]}
          value={value}

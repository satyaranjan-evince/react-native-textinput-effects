        ...
        <TextInput
          ...
          style={[
            ...
            inputStyle,
            {
              ...
              height: inputHeight,
              left: inputPadding,
              marginLeft: this.props.isRTL ? (this.props.forPhonenumber ? (dialCode.length == 0 ? 4 : (dialCode.length == 4 ? 45 : 25)) : 5) : ((this.props.forPhonenumber && !this.props.isRTL ? (dialCode.length == 0 ? 0 : (dialCode.length == 4 ? 45 : 30)) : 0)),
              marginRight: this.props.isRTL ? ((this.props.forPhonenumber && !this.props.isRTL ? (dialCode.length == 0 ? 0 : (dialCode.length == 4 ? 45 : 25)) : 0)) : 5,
            },
          ]}
          value={value}
          onBlur={this.onBlur}
